        ...
        with swan_sub1:
            ...
            if available_years:
                ...
                if st.button("Run SWAN Analysis", type="primary"):
                    ...
                    fig_hs = go.Figure(data=go.Contour(
                    ...
                    fig_hs.update_layout(title="Wave Height Distribution", height=500, xaxis_title="Distance from West (m)", yaxis_title="Distance from South (m)")
                    st.plotly_chart(fig_hs, use_container_width=True)
                    
                    fig_tp = go.Figure(data=go.Contour(
                        z=wave_periods_grid,
                        x=[f"{i*500}m" for i in range(NX)],
                        y=[f"{i*500}m" for i in range(NY)],
                        colorscale='Plasma',
                    ...
                    fig_tp.update_layout(title="Wave Period Distribution", height=500, xaxis_title="Distance from West (m)", yaxis_title="Distance from South (m)")
                    st.plotly_chart(fig_tp, use_container_width=True)
